...
export function getNameServersConfigOutput(args: GetNameServersConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNameServersConfigResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
