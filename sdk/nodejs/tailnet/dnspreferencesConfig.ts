...
export class DNSPreferencesConfig extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DNSPreferencesConfig {
        return new DNSPreferencesConfig(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tailscale-native:tailnet:DNSPreferencesConfig';

    /**
     * Returns true if the given object is an instance of DNSPreferencesConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DNSPreferencesConfig {
     ...
     */
    constructor(name: string, args: DNSPreferencesConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DNSPreferencesConfig.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DNSPreferencesConfigArgs {
