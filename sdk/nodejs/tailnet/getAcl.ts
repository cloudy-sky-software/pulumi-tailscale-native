...
export interface GetAclResult {
    readonly acls: outputs.tailnet.AclRule[];
    readonly autoApprovers: any;
    readonly groups: any;
    readonly hosts: any;
    readonly nodeAttrs: outputs.tailnet.NodeAttrs[];
    readonly ssh: outputs.tailnet.SshRule[];
    readonly tagOwners: any;
