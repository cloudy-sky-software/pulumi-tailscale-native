...
class CreateKeyArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def ephemeral(self) -> pulumi.Input[_builtins.bool]:
        return pulumi.get(self, "ephemeral")

    @ephemeral.setter
    def ephemeral(self, value: pulumi.Input[_builtins.bool]):
        pulumi.set(self, "ephemeral", value)

    @_builtins.property
    @pulumi.getter
    def preauthorized(self) -> pulumi.Input[_builtins.bool]:
        return pulumi.get(self, "preauthorized")

    @preauthorized.setter
    def preauthorized(self, value: pulumi.Input[_builtins.bool]):
        pulumi.set(self, "preauthorized", value)

    @_builtins.property
    @pulumi.getter
    def reusable(self) -> pulumi.Input[_builtins.bool]:
        return pulumi.get(self, "reusable")

    @reusable.setter
    def reusable(self, value: pulumi.Input[_builtins.bool]):
...
class NodeAttrsArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def attr(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "attr")

    @attr.setter
    def attr(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        pulumi.set(self, "attr", value)

    @_builtins.property
    @pulumi.getter
    def target(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "target")

    @target.setter
    def target(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class SshRuleArgs:
    ...
    def check_period(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "check_period")

    @check_period.setter
    def check_period(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "check_period", value)

    @_builtins.property
    @pulumi.getter
    def dst(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "dst")

    @dst.setter
    def dst(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        pulumi.set(self, "dst", value)

    @_builtins.property
    @pulumi.getter
    def src(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "src")

    @src.setter
    def src(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
