...
class KeyExpiryArgs:
    def __init__(__self__, *,
                 key_expiry_disabled: pulumi.Input[builtins.bool],
    ...
    def key_expiry_disabled(self) -> pulumi.Input[builtins.bool]:
        return pulumi.get(self, "key_expiry_disabled")

    @key_expiry_disabled.setter
    def key_expiry_disabled(self, value: pulumi.Input[builtins.bool]):
...
@pulumi.type_token("tailscale-native:device:KeyExpiry")
class KeyExpiry(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="keyExpiryDisabled")
    def key_expiry_disabled(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "key_expiry_disabled")
