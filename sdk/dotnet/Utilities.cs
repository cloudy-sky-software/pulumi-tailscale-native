...
namespace Pulumi.TailscaleNative
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.TailscaleNative.version.txt");
    ...
    internal sealed class TailscaleNativeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public TailscaleNativeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
